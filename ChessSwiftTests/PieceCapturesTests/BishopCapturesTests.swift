...
class BishopCapturesTests: XCTestCase {
    ...
    func testCaptureWhiteBishopFromA1ToH8() {
        ...
        boardState = BoardHandler.putPiece(.blackBishop, on: H8, boardState: boardState)
        XCTAssertNotNil(boardState)
    ...
    func testCaptureWhiteBishopFromH1ToA8() {
        ...
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.putPiece(.blackBishop, on: A8, boardState: boardState)
        XCTAssertNotNil(boardState)
    ...
    func testCaptureWhiteBishopFromD4ToE5ToF4() {
        ...
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.putPiece(.blackBishop, on: F4, boardState: boardState)
        XCTAssertNotNil(boardState)
    ...
    func testCaptureBlackBishopFromA1ToH8() {
        ...
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.putPiece(.whiteBishop, on: H8, boardState: boardState)
        XCTAssertNotNil(boardState)
        XCTAssertNotNil(BoardHandler.move(MoveState(fromSquare: A1, toSquare: H8), boardState: boardState))
    }
    ...
    func testCaptureBlackBishopFromH1ToA8() {
        ...
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.putPiece(.whiteBishop, on: A8, boardState: boardState)
        XCTAssertNotNil(boardState)
        XCTAssertNotNil(BoardHandler.move(MoveState(fromSquare: H1, toSquare: A8), boardState: boardState))
    }
    ...
    func testCaptureBlackBishopFromD4ToE5ToF4() {
        ...
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.putPiece(.whiteBishop, on: F4, boardState: boardState)
        XCTAssertNotNil(boardState)
        boardState = BoardHandler.move(MoveState(fromSquare: D4, toSquare: E5), boardState: boardState)
        XCTAssertNotNil(boardState)
        XCTAssertNotNil(BoardHandler.move(MoveState(fromSquare: E5, toSquare: F4), boardState: boardState))
